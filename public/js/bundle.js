...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic29ub3JhbnN0dWRpb3MiLCJhIjoiY2xoZTJmMTd1MHNvYzNrbGszczY3ZXd6OSJ9.CpfUpuYNfGHk_Y5Lk8Zaxw';
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51N7NsTEzlcJCpayUFAqhgk3MV2v03ANrqineh4WhIiDkb2bTBi1Im0BoeB8f7T3lmtxupuTNuag9lTjWC4BhBC8v00JsWP2wiG');
          _context.prev = 1;
          _context.next = 4;
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  var passwordConfirm = document.getElementById('confirmPasswordSignUp').value;
